...
VALUES(0000, 'The Book of the Unnamed Midwife', 'When she fell asleep, the world was doomed. When she awoke, it was dead.', 0, 0, 'images/Books/sci_fi/the book of the unnames midwife.jpg'),
	  (0001, 'Deaths End', 'The New York Times bestselling conclusion to a tour de force near-future adventure trilogy from Chinas bestselling and beloved science fiction writer.', 0, 0, 'images/Books/sci_fi/deaths end.jpg'),
	  (0002, 'The Obelisk Gate (The Broken Earth)', 'This is the way the world ends, for the last time. The season of endings grows darker, as civilization fades into the long cold night.', 0, 0, 'images/Books/sci_fi/the obelisk gate.jpg'),
	  (0003, 'All the Birds in the Sky', 'From the former editor-in-chief of io9.com, a stunning novel about the end of the world―and the beginning of our future', 0, 0, 'images/Books/sci_fi/all the birds in the sky.jpg'),
	  (0004, 'The Invisible Library', 'Collecting books can be a dangerous prospect in this fun, time-traveling, fantasy adventure from a spectacular debut author.', 0, 0, 'images/Books/sci_fi/the invisible library.jpg'),
	  (0005, 'The Hike: A Novel', 'From the author of The Postmortal, a fantasy saga unlike any you’ve read before, weaving elements of folk tales and video games into a riveting, unforgettable adventure of what a man will endure to return to his family', 0, 0, 'images/Books/sci_fi/the hike.jpg'),
	  (0006, 'Every Heart a Doorway', 'Read Every Heart a Doorway, the transformative book that won the 2017 Alex Award, is a finalist for the Hugo and Nebula Awards for Best Novella, and made the 2016 Tiptree Honor List', 0, 0, 'images/Books/sci_fi/every heart a doorway.jpg'),
	  (0007, 'Ninefox Gambit', 'To win an impossible war Captain Kel Cheris must awaken an ancient weapon and a despised traitor general.', 0, 0, 'images/Books/sci_fi/ninefox gambit.jpg'),
	  (0008, 'Age of Myth', 'The Age of Myth is over; the time of rebellion has begun.', 0, 0, 'images/Books/sci_fi/age of myth.jpg'),
	  (0009, 'The Biabolid', 'A Diabolic is ruthless. A Diabolic is powerful. A Diabolic has a single task: Kill in order to protect the person you’ve been created for.', 0, 0, 'images/Books/sci_fi/the diabolic.jpg'),
	  ...
	  (0020, 'Big Little Lies', 'The #1 New York Times bestseller that Entertainment Weekly called “a surefire hit.”', 0, 0, 'images/Books/mystert/big little lies.jpg'),
	  ...
	  (0040, 'Romeo and Juliet', 'No Fear Shakespeare gives you the complete text of Romeo and Juliet on the left-hand page, side-by-side with an easy-to-understand translation on the right.', 0, 0, 'images/Books/drama/remeo and juliet.jpg'),
	  ...
	  (0100, 'Samsung 4K Ultra HD TV', 'Samsung 55" Class (54.6" Diag.) - LED - 2160p - Smart - 4K Ultra HD TV.', 0, 1, 'images/technology/TV&Home Theater/Samsung - 55".jpg'),
	  (0101, 'Insignia™ - 32" HDTV', 'Insignia™ - 32" Class - (31.5" Diag.) - LED - 720p - HDTV - Black', 0, 1, 'images/technology/TV&Home Theater/insignia-32".jpg'),
	  (0102, 'Toshiba - 50" HDTV', 'Toshiba - 50" Class (49.5" Diag.) - LED - 1080p - HDTV - Black', 0, 1, 'images/technology/TV&Home Theater/toshiba-50".jpg'),
	  (0103, 'Amazon Fire TV', 'Amazon Fire TV supports 4K Ultra HD for true-to-life picture quality. Watch high-definition 1080p streams on Amazon Video, Netflix, YouTube, Hulu and more, even without a 4K TV.', 0, 1, 'images/technology/TV&Home Theater/Amazon Fire TV.jpg'),
	  (0104, 'Fire TV Stick with Alexa Voice Remote', 'The next generation of our bestselling Fire TV Stick. The most powerful streaming media stick under $50–now with the Alexa Voice Remote.', 0, 1, 'images/technology/TV&Home Theater/Fire TV Stick with Alexa Voice Remote.jpg'),
	  ...
	  (0200, 'Boat Neck Loose Top', 'Boat neck, 3/4 sleeve, Plain, Loose', 0, 2, 'images/clothes/women/top/boat neck.jpg'),
